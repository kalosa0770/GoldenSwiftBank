            ...
            <nav className="flex items-center justify-between max-w-7xl mx-auto">
                ...
                <ul className="hidden md:flex items-center gap-6 list-none text-sm">
                    ...
                    <li className='bg-amber-500 hover:bg-amber-400 text-white rounded-full py-2 px-5 text-sm font-bold transition duration-200 shadow-lg'>
                        <a href="#" className='decoration-none text-white'>Sign up</a>
                    </li>
                </ul>
...
const Services = () => {
    ...
    // State to track direction: 'forward' or 'backward'
    ...
    // Get the current item's ID (title is fine for a unique key)
    ...
    return (
        <div  className="grid grid-cols-1 md:grid-cols-2 bg-gray-200 py-20 px-4 md:px-8 items-center justify-center w-full max-w-7xl mx-auto">
            ...
            {/* RIGHT SIDE: Animated Card (SwitchTransition is key for slide-out/slide-in) */}
            <SwitchTransition mode="out-in">
                <CSSTransition
                    key={currentItem.title} // Key changes to trigger the transition
                    nodeRef={nodeRef}
                    addEndListener={(node, done) => node.addEventListener("transitionend", done, false)}
                    classNames={transitionClass} // Uses the custom CSS classes defined above
                    timeout={300} // Matches the CSS animation duration
                >
                    <div 
                        ...
                        // This overflow-hidden is crucial to ensure the sliding content is clipped
                    >
                        {/* Icon and Title */}
                        ...
                        {/* Card Footer (e.g., Learn More Button) */}
    ...
    return (
        <section className="py-20 bg-white items-center justify-center">
            <div className="max-w-4xl mx-auto px-4">
                ...
                {/* Optional CTA Button below the steps */}
        ...
        <footer className="bg-gray-800 text-white pt-16 pb-10">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-2 md:grid-cols-5 gap-10">
                    ...
                    {/* Column 1: Logo and Contact (2/5 width on desktop) */}
                ...
                <div className="mt-12 border-t border-gray-700 pt-8 flex flex-col md:flex-row items-center justify-between">
                    ...
                    {/* Social Media Icons (You would replace text with actual SVG icons) */}
...
const HomePage = ({onLoginClick}) => (
    // Use a clean white background for contrast
